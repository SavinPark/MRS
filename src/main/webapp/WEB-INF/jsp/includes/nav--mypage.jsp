	...
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				...
				<li><a href="http://localhost:9000/MRStest/customer">Customer
						Info</a></li>
				<li><a href="http://localhost:9000/MRStest/support">Support
						Board</a></li>
			</ul>
				...
				<li class="dropdown">
					...
					<c:if test="${employee != null }">
						<ul class="dropdown-menu">
							...
							<li  class="active"><a class="dropdown-item" href="http://localhost:9000/MRStest/mypage">마이페이지</a></li>
						</ul>
					</c:if>
				</li>
			</ul>
