			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li class="active" ><a class="dropdown-item" href="http://localhost:9000/MRStest/login">로그인</a></li>
					...
					<c:if test="${employee != null }">
						<ul class="dropdown-menu">
							...
							<li><a class="dropdown-item" href="http://localhost:9000/MRStest/mypage?employee_id=${employee.employee_id}">마이페이지</a></li>
						</ul>
					</c:if>
				</li>
			</ul>
