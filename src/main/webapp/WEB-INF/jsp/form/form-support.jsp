...
<body>
	...
	<script type="text/javascript">
		...
		function addFile() {
			...
			alert($("input[name=upload]").length);
		}
		function deleteFile(obj) {
			obj.parent().remove();
			alert($("input[name=upload]").files.length);
		}
		...
		$('#submit').on('click', function() {
			...
			$("#support_number_of_files").attr("value", $("input[name=upload]").length);
